...
{
    public class OnlineBoatBooking
    {
        ...
        public string BRSBookingPIN { get; set; }//newly Added.
        public string BRSChargeType { get; set; }
        public string BRSTimeSlot { get; set; }
        public string BRSOthersRescheduleDate { get; set; }
        public string BankName { get; set; }

    }

    public class OnlineBoatBookingList
    {
        public List<OnlineBoatBooking> Response
        {
    ...
    public class OnlineBoatBookingStr
    {
